...
{
    public:
        RotationalCalibState( IOTable *io ) : State( "rotationalcalib_state" ), inputs(io->inputs), outputs(io->outputs), internal_state(ROTATIONALCALIB_INIT), current_PWM(0), start_x(0.0), found_optimal(false) {}
