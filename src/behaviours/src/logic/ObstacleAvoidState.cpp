#include "ObstacleAvoidState.h"
#include "../TagUtilities.h"
#include "../waypoints/SimpleWaypoint.h"

void ObstAvoidState::action()
{
    forceTransition( internalTransition() );
    internalAction();
}

void ObstAvoidState::onEnter( std::string prev_state )
{
    
}

void ObstAvoidState::onExit( std::string next_state )
{

}

std::string ObstAvoidState::transition()
{
    
}

FHState ObstAvoidState::internalTransition()
{
    AvoidState transition_to = internal_state;
...
void ObstAvoidState::internalAction()
{
    switch( internal_state )
    {
        default: break;
...
void ObstAvoidState::forceTransition( FHState transition_to )
{
