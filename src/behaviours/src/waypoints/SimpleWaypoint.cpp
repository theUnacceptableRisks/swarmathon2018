...
SimpleWaypoint::SimpleWaypoint( LogicInputs *i, SimpleParams sp ) : Waypoint( i ), simple_params(sp)
{
    ...
    vel_config.Ki = 10; //integral constant
    vel_config.Kd = 2; //derivative constant
    ...
    vel_config.feedForwardMultiplier = 610; //gives 127 pwm at 0.4 commandedspeed  ORIG:320
